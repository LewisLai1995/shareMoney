...
function HomeScreen({ currentUser, onEnterBook }) {
  ...
  return (
    <>
    <div style={{ minHeight:"100vh",background:"#F0F7FF",fontFamily:"'Noto Sans TC',sans-serif",display:"flex",flexDirection:"column",alignItems:"center",padding:"40px 16px 80px",minHeight:"100vh" }}>
